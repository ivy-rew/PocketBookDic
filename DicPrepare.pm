...
sub cleanseAr{
    ...
    # Usage: my $Content = cleanseAr( $Content );
    # Special characters in $head and $def should be converted to HTML escape sequences. Controlled with $isEscapeHTMLCharacters.
    my $Content = escapeHTMLString( join('',@_) );
